...
public class UString {
	...
	public static String join(CharSequence delimiter, CharSequence... elements) {
		CharSequence[] strings = UEmpty.trim(true, elements);
		return strings.length == 0 ? EMPTY : String.join(delimiter, strings);
	}
	...
	private static void upper(StringBuilder builder, String string, int start) {
	...
	private static void upper(StringBuilder builder, String string, int start, int end) {
		if (start == end) {
			return;
		}
		builder.append(Character.toUpperCase(string.charAt(0)));
	...
	private static void lower(StringBuilder builder, String string, int start) {
		int end = string.length();
		if (start == end) {
			return;
		}
	...
	private static void lower(StringBuilder builder, String string, int start, int end) {
		if (start == end) {
			return;
		}
		builder.append(Character.toLowerCase(string.charAt(0)));
