...
public class CustomCommentGenerator extends DefaultCommentGenerator {
	...
	private void resolveImports(TopLevelClass klass, IntrospectedTable table) {
		Util.addImport(klass, Data.class);
		Util.addImport(klass, Id.class);
		Util.addImport(klass, Table.class);
		Util.addImport(klass, Column.class);
		Util.addImport(klass, Entity.class);
		Util.addImport(klass, ApiModel.class);
		Util.addImport(klass, ApiModelProperty.class);
		...
		if (hasNullable) {
			Util.addImport(klass, Nullable.class);
		}
		if (hasNotNull) {
			Util.addImport(klass, NotNull.class);
		}
		if (hasNotBlank) {
			Util.addImport(klass, NotBlank.class);
		}
		if (hasLength) {
			Util.addImport(klass, Length.class);
		}
	}
