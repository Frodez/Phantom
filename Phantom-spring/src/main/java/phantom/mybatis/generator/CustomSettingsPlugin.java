...
public class CustomSettingsPlugin extends PluginAdapter {
	 ...
	 */
	public static String MAPPER_NAME;
	...
	private void makeSerializable(TopLevelClass klass, IntrospectedTable table) {
		Util.addImport(klass, Serializable.class);
