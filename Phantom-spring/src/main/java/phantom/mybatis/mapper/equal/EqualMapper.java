...
public interface EqualMapper<T> {
	...
	List<T> selectEq(@Param("paramName") String paramName, @Param("param") Object param);
	 ...
	 */
	@SelectProvider(type = EqualMapperProvider.class, method = "dynamicSQL")
	T selectOneEq(@Param("paramName") String paramName, @Param("param") Object param);
	...
	int deleteEq(@Param("paramName") String paramName, @Param("param") Object param);
	...
	int updateEq(@Param("paramName") String paramName, @Param("param") Object param, T record);
	 ...
	 */
	@UpdateProvider(type = EqualMapperProvider.class, method = "dynamicSQL")
	int updateSelectiveEq(@Param("paramName") String paramName, @Param("param") Object param, T record);
