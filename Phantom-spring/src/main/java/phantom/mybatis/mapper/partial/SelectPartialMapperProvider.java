package phantom.mybatis.mapper.partial;
...
public class SelectPartialMapperProvider extends MapperTemplate {
	...
	public String partialNone(MappedStatement ms) {
	...
	public String partialEq(MappedStatement ms) {
		final Class<?> entityClass = getEntityClass(ms);
		String tableName = tableName(entityClass);
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT ");
	...
	public String partialOneEq(MappedStatement ms) {
		return partialEq(ms);
	}
